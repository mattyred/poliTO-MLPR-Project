...
\begin{table}[ht!]
	...
	\begin{tabular}{ |l|l|l|l| }
		...
		\hline
		\multirow{4}{*}{}
		 Tied Gaussian & \small{0.122 / 0.127} & \small{0.046 / 0.050} & \small{0.127 / 0.134}\\
		 Lnear LR & \small{0.132 / 0.139} & \small{0.047 / 0.048} & \small{0.126 / 0.136}\\
		 Linear SVM & \small{0.132 / 0.289} & \small{0.047 / 0.047} & \small{0.129 / 0.285}\\
		 Tied GMM & \small{0.099 / 0.110} & \small{0.031 / 0.031} & \small{0.075 / 0.081}\\
		\hline
		\multicolumn{4}{ |c| }{\bf{Calibrated scores [minDCF / DCF]}} \\
		\hline
		\multirow{4}{*}{}
		Tied Gaussian & \small{0.122 / 0.128} & \small{0.046 / 0.049} & \small{0.127 / 0.135}\\
		Lnear LR & \small{0.132 / 0.141} & \small{0.047 / 0.048} & \small{0.126 / 0.132}\\
		Linear SVM & \small{0.132 / 0.135} & \small{0.047 / 0.047} & \small{0.129 / 0.137}\\
		Tied GMM & \small{0.099 / 0.105} & \small{0.031 / 0.031} & \small{0.075 / 0.076}\\
		\hline
	\end{tabular}
\end{table}
\FloatBarrier
...
\begin{table}[ht!]
	...
	\begin{tabular}{ |l|l|l|l| }
		...
		\hline
		\multicolumn{4}{ |c| }{\bf{GMM Models (TODO)}} \\
		\hline
		\multirow{6}{*}{}
		GMM Full (8 comp.) & 0.092 & 0.034 & 0.086 \\
		GMM Full (16 comp.) & 0.103 & 0.043 & 0.117 \\

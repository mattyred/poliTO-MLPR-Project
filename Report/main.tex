...
task on a datased made of 13 observations coming from speking embedders. Class labels are male and female and different
classification models are applied and evalued by showing how the behave on the assigned task}

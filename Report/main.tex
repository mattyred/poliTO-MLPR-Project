...
By plotting one histogram for each feature, separately for classes male and female, it is possible to show
...
dimensioanlity reduction techniques that we have analyzed and that could be applied: PCA and LDA.
%%%%%%%%%%%%%%%%%%%%%%
%%% PCA DISCUSSION %%%
%%%%%%%%%%%%%%%%%%%%%%
\subsection{PCA}
...
highest variance).\\Starting from the empirical covariance matrix
\begin{center}
	\begin{math}
...
\end{center}
More in general we can introduce a weight term instead of the prior probability that will
